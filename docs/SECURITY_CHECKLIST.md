...
- At the day-14 (outreach start + 14 days — see `OUTREACH_14_DAY.md`) and day-30 (**2026-09-26**) reviews (this project has no formal `PHASE_TRANSITION_GATES.md` — those two dates are the gate)
